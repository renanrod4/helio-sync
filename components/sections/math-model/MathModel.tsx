...
const accentClasses: Record<
	Accent,
	{ badge: string; cardBorder: string; formulaColor: string; cardGradient: string; formulaSurface: string }
> = {
	green: {
		badge: 'border-[rgb(50_205_50/0.35)] bg-[rgb(50_205_50/0.08)] text-helio-green',
	...
	gold: {
		badge: 'border-[rgb(255_215_0/0.35)] bg-[rgb(255_215_0/0.08)] text-helio-gold',
...
export default function MathModel() {
	return (
		<section className="relative bg-helio-bg-secondary py-20">
			...
			<div className="relative z-10 mx-auto flex w-full max-w-340 flex-col items-center gap-6 px-4 md:px-8">
				...
				<div className="mt-4 grid w-full gap-8 xl:grid-cols-[1.05fr_1fr]">
							...
							return (
								...
								>
									<div className="mb-7 flex items-start gap-4">
										<span
											className={`inline-flex h-10 w-10 items-center justify-center rounded-xl border text-3xl ${accent.badge}`}
										>
											{card.symbol}
										</span>
										<div>
						...
						<div className="mt-6 space-y-5">
							{variables.map(item => {
								...
								return (
									...
									>
										<span
											className={`mt-0.5 inline-flex h-10 w-10 items-center justify-center rounded-xl border px-4 text-2xl ${accent.badge}`}
										>
											{item.symbol}
										</span>
										<div>
